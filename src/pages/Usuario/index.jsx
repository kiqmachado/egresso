...
const Usuario = () => {
  ...
  const [error, setError] = useState("MAS QUE ROLA");
              ...
              <div className="containerUsuario">
                  <div className="informacaoUsuario">
                      <div className="infoEsq">
                          ...
                          <input className="btnEditarFoto" type="file" onChange={(event) => {setImageUpload(event.target.files[0]);}}/>
                          <button onClick={uploadFile}className="btnRemoverDepoimento">Confirmar Foto</button>
                      ...
                      <div className="infoDir">
                          ...
                          <div className="dadosUsuario">
                              ...
                              <input className='inputUsuario' id="cpf" type="number" placeholder="CPF" value={cpf} onChange={(e)=>{setCpf(e.target.value)}}></input>
